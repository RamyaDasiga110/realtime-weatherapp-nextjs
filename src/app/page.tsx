          ...
          <>
            <section className="space-y-4 ">
              <div className="space-y-2">
                <h2 className="flex gap-1 text-2xl  items-end font-bold">
              ...
              <div className=" flex gap-4">
                ...
                <Container className="bg-sky-200/80  px-6 gap-4 justify-between overflow-x-auto">
                  <WeatherDetails
                    ...
                    sunrise={format
                      (fromUnixTime(data?.city.sunrise ?? 1716090541), "H:mm"
                    )}
                    // sunrise={}
                    sunset={format
                      (fromUnixTime(data?.city.sunset ?? 1716144063), "H:mm"
                    )}
                    windSpeed={convertWindSpeed(firstData?.wind.speed ?? 6.28)}
                  />
              </Container>
                {/* right  */}
              </div>
            ...
            <section className="flex w-full flex-col gap-4  ">
              <p className="text-2xl font-bold">Forcast (7 days)</p>
              {firstDataForEachDate.map((d, i) => (
                <ForecastWeatherDetail
                  ...
                  sunrise={format(
                    fromUnixTime(data?.city.sunrise ?? 1716144063),
                    "H:mm"
                  )}
                  sunset={format(
